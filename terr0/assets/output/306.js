var module210 = require('./210'),
  ...
  t = module307.currentCentroidXOfTouchesChangedAfter,
  u = module307.currentCentroidYOfTouchesChangedAfter,
  s = module307.previousCentroidXOfTouchesChangedAfter,
  c = module307.previousCentroidYOfTouchesChangedAfter,
  p = module307.currentCentroidX,
  v = module307.currentCentroidY,
  h = {
      ...
      return {
        panHandlers: {
          ...
          onResponderGrant: function (s) {
            if (!t.handle) t.handle = module210.createInteractionHandle();
...
function l(o, t, u, s) {
  if (o.handle) {
    module210.clearInteractionHandle(o.handle);
    o.handle = null;
  }
