...
module.exports = function (p, c, u) {
  var l = [],
    ...
    h = {
      ...
      childContextTypes: function (n, o) {
        n.childContextTypes = module50({}, n.childContextTypes, o);
      },
      contextTypes: function (n, o) {
        n.contextTypes = module50({}, n.contextTypes, o);
      },
      ...
      propTypes: function (n, o) {
        n.propTypes = module50({}, n.propTypes, o);
      },
  ...
  function N(t, n) {
    if (n) {
      module198('function' != typeof n, "ReactClass: You're attempting to use a component class or function as a mixin. Instead, just use a regular object.");
      module198(!c(n), "ReactClass: You're attempting to use a component as a mixin. Instead, just use a regular object.");
      var p = t.prototype,
        ...
        if (n.hasOwnProperty(l) && l !== s) {
          ...
          if ((y(N, l), h.hasOwnProperty(l))) h[l](t, f);
            ...
            if ('function' != typeof f || _ || N || false === n.autobind) {
              if (N) {
                var D = E[l];
                module198(_ && ('DEFINE_MANY_MERGED' === D || 'DEFINE_MANY' === D), 'ReactClass: Unexpected spec policy %s for key %s when mixing in component specs.', D, l);
      ...
      for (var s in n) {
        ...
        if (n.hasOwnProperty(s)) {
          if (
            ...
            module198('DEFINE_MANY_MERGED' === c, 'ReactClass: You are attempting to define `%s` on your component more than once. This conflict may be due to a mixin.', s);
  ...
  function D(t, n) {
    for (var s in (module198(t && n && 'object' == typeof t && 'object' == typeof n, 'mergeIntoWithNoDuplicateKeys(): Cannot merge non-objects.'), n))
      n.hasOwnProperty(s) &&
        (module198(
          undefined === t[s],
  ...
  module50(R.prototype, p.prototype, P);
  return function (t) {
    var s = function (t, p, c) {
      ...
      module198('object' == typeof l && !Array.isArray(l), '%s.getInitialState(): must return an object or null', s.displayName || 'ReactCompositeComponent');
      this.state = l;
    };
    ...
    module198(s.prototype.render, 'createClass(...): Class specification must implement a `render` method.'),
    E))
