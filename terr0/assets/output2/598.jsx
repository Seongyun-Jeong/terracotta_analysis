...
var I = module2.Dimensions.get('window'),
  C = I.width,
  M = I.height,
  ...
  j = true,
  L = function (t) {
    if ('ios' === module2.Platform.OS) return t && !module2.Platform.isPad ? 32 : x ? 88 : 64;
  ...
  X = (function (t) {
    function o(t) {
      ...
      n.panGestureRef = React.createRef();
    ...
    module357(o, [
      {
        ...
        value: function (t, s) {
          ...
          var P = this.props,
            k = P.transitionProps,
            V = module370(P, ['transitionProps']);
          return (
            <module373.NavigationProvider value={t.descriptor.navigation}>
              {l(
                O({}, V, {}, k, {
      ...
      },
      {
        key: '_reset',
        value: function (t, n) {
          if ('ios' === module2.Platform.OS && module615.supportsImprovedSpringAnimation())
      ...
      },
      {
        ...
        value: function () {
          ...
          if ('float' === l) {
            var u = t.scene;
            p = (
              <module2.View style={Y.floatingHeader} pointerEvents="box-none" onLayout={this._onFloatingHeaderLayout}>
                <u />
              </module2.View>
            );
          }
      ...
      },
      {
        ...
        value: function (t) {
          ...
          return module617.default(p - 1, h, p);
        },
      },
      {
      ...
      },
      {
        ...
        value: function () {
          ...
          if (t && B.includes(t)) {
            if ('fade' === t) return module610.default.forBackgroundWithFade;
            if ('translate' === t) return module610.default.forBackgroundWithTranslation;
            if ('toggle' === t) return module610.default.forBackgroundWithInactiveHidden;
          }
      ...
      },
      {
        ...
        value: function () {
          this._transitionConfig = module613.default.getTransitionConfig(
