...
exports.default = function (u, l) {
  var h,
    v,
    y = '__create-react-context-' + (0, module387.default)() + '__',
    b = (function (t) {
      function n() {
        var module387, u, p, f;
        s(this, n);
        ...
        module387 = u = c(this, t.call.apply(t, [this].concat(h)));
        u.emitter =
          ((p = u.props.value),
          (f = []),
          {
  ...
  var _ = (function (t) {
    function n() {
      ...
      module387 = u = c(this, t.call.apply(t, [this].concat(f)));
      u.state = {
        value: u.getValue(),
      };
