export default function default(t, n, c, u) {
  ...
  if (b.forEach(function (t, n) {
    ...
    module467.default(!k.has(c), "navigation.state.routes[" + n + "].key \"" + c + "\" conflicts with another route!");
    k.add(c);
  ...
  if (w.forEach(function (t, o) {
    ...
    if (c) j++;
  }), module467.default(1 === j, 'there should always be only one scene active, not %s.', j), w.length !== t.length) return w;
...
function h(t, n) {
  return t && n ? t.key === n.key && module485.default(t, n) : t === n;
}