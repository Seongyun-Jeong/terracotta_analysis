          ...
          for (var o = t; null != o; ) {
            for (
              var l = Object.getOwnPropertyNames(o),
                u = Array.isArray(l),
                f = 0,
                l = u ? l : l['function' == typeof Symbol && 'function' == typeof Symbol && 'function' == typeof Symbol ? Symbol.iterator : '@@iterator']();
              ;
              ...
              var p = c;
              if (!(p.startsWith('_') || p.startsWith('component') || v.has(p) || 'function' != typeof o[p] || undefined !== n[p]))
                o[p].prototype ? (n[p] = o[p].bind(t)) : (n[p] = o[p]);
            }
...
function O(t) {
  for (var n = 1; n < arguments.length; n++) {
    ...
    if (n % 2)
      b(Object(l), true).forEach(function (n) {
