...
export default function default(t) {
  ...
  var h = p.order || Object.keys(t),
      ...
      N = h.indexOf(P);
  if (-1 === N) throw new Error("Invalid initialRouteName '" + P + "'.Should be one of " + h.map(function (t) {
    return "\"" + t + "\"";
  }).join(', '));
  var k = {};
  ...
  return {
    ...
    getStateForAction: function (t, o) {
      ...
      if (t.type === module378.default.INIT) {
        var v = t.params;
        if (v) f.routes = f.routes.map(function (t) {
          return y({}, t, {
      ...
      if (t.type === module378.default.BACK) if (F && 'initialRoute' === S) c = N;else if (F && 'order' === S) c = 0 ** (c - 1);else {
      ...
      if (t.type === module378.default.NAVIGATE && (K = !!h.find(function (n, o) {
      ...
      h.find(function (o, u) {
        ...
        if (s) return s !== q[u] && ((q = module392.default(q))[u] = s, L = u, true);else {
          L = u;
          return true;
        }
      });
      ...
      return L !== f.index || q !== f.routes ? E(t, u, y({}, f, {
        index: L,
        routes: q
      })) : f;
    },
