import { I18nManager } from './2';

var module611 = require('./611'),
  u = 1e-5;
...
var p = {
  forHorizontal: function (t) {
    ...
    var v = c.first,
      ...
      M = s.interpolate({
        inputRange: [v, R, y],
        outputRange: I18nManager.isRTL ? [-x, 0, 0.3 * x] : [x, 0, -0.3 * x],
        extrapolate: 'clamp',
      }),
      h = t.shadowEnabled
        ? s.interpolate({
