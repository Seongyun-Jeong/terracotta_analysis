    ...
    module357(n, [
      {
        ...
        value: function () {
          var t = this.props,
            ...
            E = C.shadowOpacity,
            P = C.overlayOpacity,
            k = module370(C, ['shadowOpacity', 'overlayOpacity']),
            A = module2.StyleSheet.flatten(c) || {},
            R = A.backgroundColor,
            x = module370(A, ['backgroundColor']);
          return (
            <module464.Screen pointerEvents={s} onComponentRef={this.props.onComponentRef} style={[module2.StyleSheet.absoluteFill, k, x]} active={S}>
              {!f && E
