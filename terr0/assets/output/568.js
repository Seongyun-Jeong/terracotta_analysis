exports.default = function (n, s, u) {
  ...
  return module524.block([
    module524.set(s.position, _),
    module524.set(s.velocity, f),
    module524.set(s.time, n),
    module524.cond(module524.lessThan(module552.abs(f), l), module524.set(s.finished, 1)),
  ]);
};
