...
var f = module2.Dimensions.get('window').width / 2 - 70 - 25;
var c = module2.Dimensions.get('window').width / 2 - 70 + 25;
var l = {
    opacity: 1,
  },
  v = {
...
var x = module2.Dimensions.get('window').width;
var y = {
  forLayout: function (t) {
    ...
    var v = p(l),
      R = module611.default(t);
    if (!R) return {};
    var x = R.first,
      y = R.last,
      h = c.index,
      w = s.initWidth || module2.Dimensions.get('window').width;
    ...
    var L = module2.I18nManager.isRTL ? -1 : 1;
    return {
      transform: [
        {
      ...
      transform: [
        {
          translateX: s.interpolate({
            ...
            outputRange: module2.I18nManager.isRTL ? [1.5 * -y, u(c[v]) ? 1.5 * -y : 0, 0, u(c[R]) ? y : 0, y] : [y, u(c[v]) ? y : 0, 0, u(c[R]) ? 1.5 * -y : 0, 1.5 * -y],
            extrapolate: 'clamp',
          }),
        },
      ],
      ...
      transform: [
        {
          translateX: s.interpolate({
            inputRange: [v, v + 0.001, x, R - 0.001, R],
            outputRange: module2.I18nManager.isRTL ? [-y, u(f[v]) ? -y : 0, 0, u(f[R]) ? y : 0, y] : [y, u(f[v]) ? y : 0, 0, u(f[R]) ? -y : 0, -y],
            extrapolate: 'clamp',
          }),
        },
      ],
      ...
      transform: [
        {
          translateX: u.interpolate({
            inputRange: [f, l, c],
            outputRange: module2.I18nManager.isRTL ? v.reverse() : v,
            extrapolate: 'clamp',
          }),
        },
      ],
