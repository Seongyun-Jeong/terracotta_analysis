export default function default(t) {
  ...
  class G {
    constructor(n) {
      ...
      if (module356.default(this, G), (u = module358.default(this, module361.default(G).call(this, n)))._onGestureHandlerEvent = function (t) {
        ...
        u._viewNode = t;
        var n = React.Children.only(u.props.children),
            o = n.ref;
      ...
      }, u._handlerTag = T++, u._config = {}, n.id) {
    ...
    componentDidMount() {
      ...
      })(t.simultaneousHandlers) || n(t.waitFor)) this._updateEnqueued = setImmediate(function () {
    ...
    render() {
      ...
      var v = React.Children.only(this.props.children),
          y = v.props.children;
      if (module2.Touchable.TOUCH_TARGET_DEBUG && v.type && ('RNGestureHandlerButton' === v.type || 'View' === v.type.name || 'View' === v.type.displayName)) (y = React.Children.toArray(y)).push(module2.Touchable.renderDebugView({
...
function C(t, n) {
  ...
  Object.keys(n).forEach(function (n) {
    ...
    if (s = n, !(undefined === (u = l) || u === Object(u) && '__isNative' in u || 'onHandlerStateChange' === s || 'onGestureEvent' === s)) {
      var p = t[n];
      if ('simultaneousHandlers' === n || 'waitFor' === n) p = O(t[n]);else if ('hitSlop' === n && 'object' != typeof p) p = {
        top: p,
        left: p,
        bottom: p,
        right: p
