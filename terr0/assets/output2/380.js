function t(t) {
  for (var o = 1; o < arguments.length; o++) {
    var u = null != arguments[o] ? arguments[o] : {},
        c = Object.keys(u);
    if ('function' == typeof Object.getOwnPropertySymbols) c = c.concat(Object.getOwnPropertySymbols(u).filter(function (t) {
...
export default function default(n, o) {
    ...
    return n(t, function (n) {
      if ('refocus' !== t) {
        var u = n.state,
            ...
            w = f && f[u.index].key,
            y = w === o,
            F = s && s.find(function (t) {
          return t.key === o;
        }),
            b = f && f.find(function (t) {
          return t.key === o;
        }),
            S = {
        ...
        if ('willBlur' === p) 'action' !== t || y || h ? 'didBlur' === t ? B(p = 'didBlur', S) : 'action' === t && y && !h ? B(p = 'didFocus', S) : 'action' === t && y && h && B(p = 'willFocus', S) : B(p = 'didBlur', S);
        if (!('didBlur' !== p || b)) v();
      } else B(t, n);
    });
  });
  ...
  return {
    ...
    emit: function (t, n) {
      if ('refocus' === t) B(t, n);else console.error("navigation.emit only supports the 'refocus' event currently.");
    }
  };
}