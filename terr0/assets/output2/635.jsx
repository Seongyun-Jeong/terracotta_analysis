...
export default function default(t) {
    ...
    module357(n, [{
      ...
      value: function () {
        ...
        if (o) {
          ...
          if (u) this.delayTimer = setTimeout(c, u);else c();
        }
      }
    }, {
      ...
      value: function (t) {
        ...
        if (y) {
          ...
          if (n !== o && JSON.stringify(n) !== JSON.stringify(o)) u ? this.delayTimer ? this.setAnimation(u) : (v(), this.animate(u, f, p).then(function (t) {
      ...
      value: function (t, n, o, s) {
        ...
        module2.Animated.timing(f, E).start(function (n) {
          O += 1;
          if (n.finished && u.props.animation && ('infinite' === v || O < v)) u.startAnimation(t, O, o, s);else if (s) s(n);
        });
      }
    }, {
      key: "transition",
      ...
      value: function (t, n, o, s) {
        ...
        Object.keys(f).forEach(function (t) {
          ...
          if (y || v || !h || h !== b) {
            ...
            c.from[t] = T;
            c.to[t] = p;
          } else R(t, b, p, n, o, u.props.useNativeDriver, s, function (t) {
      ...
      value: function (t, n, o, s) {
        ...
        Object.keys(t).forEach(function (l) {
          var f = u.state.transitionValues[l],
              c = t[l];
          R(l, f, c, n, o, u.props.useNativeDriver, s, function (t) {
            return u.props.onTransitionBegin(t);
          }, function (t) {
            return u.props.onTransitionEnd(t);
          });
      ...
      value: function () {
        ...
        var u = N(['animation', 'duration', 'direction', 'delay', 'easing', 'iterationCount', 'iterationDelay', 'onAnimationBegin', 'onAnimationEnd', 'onTransitionBegin', 'onTransitionEnd', 'style', 'transition', 'useNativeDriver'], this.props);
        return <E />;
      }
    }]);
    return n;
  ...
  n.propTypes = {
    ...
    easing: PropTypes.oneOfType([PropTypes.oneOf(Object.keys(module642.default)), PropTypes.func]),
...
function j(t) {
  for (var n = 1; n < arguments.length; n++) {
    ...
    if (n % 2) E(Object(s), true).forEach(function (n) {
      module284.default(t, n, s[n]);
    });else if (Object.getOwnPropertyDescriptors) Object.defineProperties(t, Object.getOwnPropertyDescriptors(s));else E(Object(s)).forEach(function (n) {
...
var w = ['rotate', 'rotateX', 'rotateY', 'rotateZ', 'skewX', 'skewY', 'transformMatrix', 'backgroundColor', 'borderColor', 'borderTopColor', 'borderRightColor', 'borderBottomColor', 'borderLeftColor', 'shadowColor', 'color', 'textDecorationColor', 'tintColor'],
    D = ['width', 'height'];
...
function x(t, n) {
  ...
  Object.keys(t).forEach(function (s) {
    if ('style' === s) module51.default(o, t.style);else if ('easing' !== s) o[s] = n.interpolate(t[s]);
  });
...
function R(t, n, o, s, u) {
  var l = arguments.length > 5 && undefined !== arguments[5] && arguments[5],
      ...
      y = s || u || f ? module2.Animated.timing(n, {
    toValue: o,
    delay: f,
    duration: s || 1e3,
