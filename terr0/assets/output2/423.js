export default function default(t) {
  var b = arguments.length > 1 && undefined !== arguments[1] ? arguments[1] : {
    forwardRef: true
  },
      w = function (p) {
    function y() {
    ...
    module357(y, [{
      ...
      value: function () {
        ...
        return React.createElement(module384.default.Consumer, null, function (u) {
          var f = o || u;
          module375.default(!!f, 'withNavigation can only be used on a view hierarchy of a navigator. The wrapped component is unable to get access to navigation from props or context.');
          return React.createElement(t, h({}, n.props, {
            navigation: f,
...
import module357 from "@babel/runtime/helpers/createClass";
