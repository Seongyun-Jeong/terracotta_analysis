...
class x {
  constructor(t, u) {
    ...
    (l = module358.default(this, module361.default(s).call(this, t, u)))._computeScenes = function (t, n) {
      var s = module484.default(l.state.scenes, n.navigation.state, t.navigation.state, n.descriptors);
      if (
    ...
    l.state = {
      layout: f,
      position: h,
      scenes: module484.default([], l.props.navigation.state, null, l.props.descriptors),
    };
    l._prevTransitionProps = null;
  ...
  render() {
    return (
      <module2.View onLayout={this._onLayout} style={E.main}>
...
function b(t, n) {
  var s = t.navigation,
    ...
    c = n.scenes,
    l = c.find(S);
  module467.default(l, 'Could not find active scene');
  return {
    layout: u,
    navigation: s,
    position: p,
