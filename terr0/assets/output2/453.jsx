...
var S = 0.05,
  ...
  O = (function (t) {
    function n(t, o) {
      ...
      (s = module358.default(this, module361.default(n).call(this, t, o)))._accessibilityIsModalView = React.createRef();
      s._pointerEventsView = React.createRef();
      s._panGestureHandler = React.createRef();
      ...
      s._renderOverlay = function () {
        module3(s._openValue, 'should be set');
        var t = {
        ...
        return (
          <module438.TapGestureHandler onHandlerStateChange={s._onTapHandlerStateChange}>
            {React.createElement(module2.Animated.View, {
