export default function default(t) {
  module191.default('function' != typeof t || t.prototype && t.prototype.isReactComponent, "`createAnimatedComponent` does not support stateless functional components; use a class component instead.");
  return function (y, ...args) {
    function A() {
      ...
      n._animatedPropsCallback = function () {
        if (null == n._component) n._invokeAnimatedPropsCallbackOnMount = true;else if ('function' != typeof n._component.setNativeProps) n.forceUpdate();else n._component.setNativeProps(n._propsAnimated.__getValue());
      };
    ...
    module357(A, [{
      ...
      value: function (t) {
        ...
        for (var o in t) {
          var s = t[o];
          if ('style' === o) n[o] = this._filterNonAnimatedStyle(module2.StyleSheet.flatten(s));else if (!(s instanceof module527.default)) n[o] = s;
        }
