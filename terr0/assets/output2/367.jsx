...
export default function default(t) {
  class k {
    constructor(n) {
      ...
      l._persistNavigationState = function (t) {
        ...
        return regeneratorRuntime.async(function (s) {
          for (;;) switch (s.prev = s.next) {
            ...
            case 3:
              s.next = 5;
              return regeneratorRuntime.awrap(module2.AsyncStorage.setItem(n, JSON.stringify(t)));
      ...
      if (l._isStateful()) l.subs = module2.BackHandler.addEventListener('hardwareBackPress', function () {
    ...
    _validateProps(t) {
      if (!this._isStateful()) {
        var n = module370(t, ["navigation", "screenProps"]),
            o = Object.keys(n);
        if (0 !== o.length) throw new Error("This navigator has both navigation and container props, so it is unclear if it should own its own state. Remove props: \"" + o.join(', ') + "\" if the navigator should get its state from the navigation prop. If the navigator should maintain its own state, do not pass a navigation prop.");
      }
    }

    _onNavigationStateChange(t, n, o) {
      if (undefined === this.props.onNavigationStateChange && this._isStateful() && process.env.REACT_NAV_LOGGING) console.group ? (console.group('Navigation Dispatch: '), console.log('Action: ', o), console.log('New State: ', n), console.log('Last State: ', t), console.groupEnd()) : console.log('Navigation Dispatch: ', {
        action: o,
        newState: n,
        lastState: t
    ...
    componentDidMount() {
      ...
      return regeneratorRuntime.async(function (E) {
        for (;;) switch (E.prev = E.next) {
          ...
          case 3:
            if (0, module2.Linking.addEventListener('url', this._handleOpenURL), n = this.props, s = n.persistenceKey, u = n.uriPrefix, c = n.enableURLHandling, l = null, module362 = null, false === c) {
              E.next = 20;
              break;
            }
            ...
            E.next = 14;
            return regeneratorRuntime.awrap(module2.AsyncStorage.getItem(s));
          ...
          case 15:
            module362 = E.t0;
            E.next = 18;
            return regeneratorRuntime.awrap(module2.Linking.getInitialURL());
          ...
          case 20:
            if (f = this._initialAction, (_ = this.state.nav) || (process.env.REACT_NAV_LOGGING && console.log('Init new Navigation State'), _ = t.router.getStateForAction(f)), module362) try {
              _ = JSON.parse(module362);
              w = true;
            } catch (t) {}

            if (l && (b = (S = l).path, N = S.params, (A = t.router.getActionForPathAndParams(b, N)) && (process.env.REACT_NAV_LOGGING && console.log('Applying Navigation Action for Initial URL:', l), f = A, _ = t.router.getStateForAction(A, _))), k = function () {
    ...
    render() {
      ...
      if (this._isStateful()) {
        ...
        if (!(this._navigation && this._navigation.state === u)) this._navigation = module373.getNavigation(t.router, u, this.dispatch, this._actionEventSubscribers, this._getScreenProps, function () {
      ...
      return <module373.NavigationProvider value={s}><t /></module373.NavigationProvider>;
    }
