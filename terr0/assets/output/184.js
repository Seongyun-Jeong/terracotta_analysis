...
module.exports = function (o) {
  function l(l, c, s, u, p) {
    if (c[s]) {
      var f = c[s],
        y = typeof f;
      if ('object' !== y) module3(false, 'Invalid ' + (p || '(unknown)') + ' `' + s + '` of type `' + y + '` supplied to `' + u + '`, expected `object`.');

      for (var v = module176(c[s], o), b = arguments.length, j = new Array(b > 5 ? b - 5 : 0), k = 5; k < b; k++) j[k - 5] = arguments[k];
      ...
      for (var w in v) {
        ...
        if (J) module3(false, J.message + '\nBad object: ' + JSON.stringify(c[s], null, '  '));
      }
    } else l && module3(false, 'Required object `' + s + '` was not specified in `' + u + '`.');
  }
