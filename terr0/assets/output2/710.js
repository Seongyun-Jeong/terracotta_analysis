  ...
  onSnapshot(t, n, s) {
    ...
    if (module672.isFunction(t)) {
      ...
      if (t.next) {
        ...
        if (!Object.prototype.hasOwnProperty.call(t, 'includeMetadataChanges')) throw new Error('Query.onSnapshot failed: First argument must be a function, observer or options.');
