...
class L {
  ...
  createUserAndRetrieveDataWithEmailAndPassword(t, n) {
    var s = this;
  ...
  signInAndRetrieveDataWithEmailAndPassword(t, n) {
    var s = this;
  ...
  signInAndRetrieveDataWithCustomToken(t) {
    var n = this;
