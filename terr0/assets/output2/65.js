...
var module66 = require('./66'),
  n = {
    ...
    scaleX: module66(PropTypes.number, 'Use the transform prop instead.'),
    scaleY: module66(PropTypes.number, 'Use the transform prop instead.'),
    rotation: module66(PropTypes.number, 'Use the transform prop instead.'),
    translateX: module66(PropTypes.number, 'Use the transform prop instead.'),
    translateY: module66(PropTypes.number, 'Use the transform prop instead.'),
  };
