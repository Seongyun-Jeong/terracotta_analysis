...
class w {
  ...
  rowShouldUpdate(t, n) {
    ...
    module5(undefined !== s, 'missing dirtyBit for section, row: ' + t + ', ' + n);
    return s;
  }
  ...
  getRowData(t, n) {
    ...
    module5(undefined !== s && undefined !== o, 'rendering invalid section, row: ' + t + ', ' + n);
  ...
  sectionHeaderShouldUpdate(t) {
    ...
    module5(undefined !== n, 'missing dirtyBit for section: ' + t);
    return n;
  }
  ...
  getSectionHeaderData(t) {
    ...
    module5(undefined !== n, 'renderSection called on invalid section: ' + t);
  ...
  _calculateDirtyArrays(t, n, s) {
    for (var o, h = f(n), u = {}, l = 0; l < s.length; l++) {
      var w = n[l];
      module5(!u[w], 'SectionID appears more than once: ' + w);
      u[w] = f(s[l]);
    }
...
function f(t) {
  if (module281(t)) return {};

  for (var n = {}, s = 0; s < t.length; s++) {
    var o = t[s];
    module5(!n[o], 'Value appears more than once in array: ' + o);
    n[o] = true;
  }
