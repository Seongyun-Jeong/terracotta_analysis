exports.default = function (o, n, u) {
  ...
  return module524.block([
    module524.cond(module524.greaterOrEq(l, u.duration), [module524.set(n.position, u.toValue), module524.set(n.finished, 1)], module524.set(n.position, _)),
    module524.set(n.frameTime, l),
    module524.set(n.time, o),
  ]);
};
