...
export default function default(t) {
  ...
  b.forEach(function (n) {
    ...
    if (o && o.router) T[n] = o.router;else T[n] = null;
  });
  ...
  function E(n) {
    ...
    if (A(n) && undefined !== f) {
      ...
      if (null !== f) {
        var l = n.action || module378.default.init({
          params: n.params
        });
    ...
    if (R) u = R.getStateForAction(module378.default.navigate({
      routeName: O,
      params: h
    }));
  ...
  return {
    ...
    getActionCreators: function (t, n) {
      return k({}, x(t, n), {
        pop: function (t, n) {
          return module401.default.pop(k({
            n: t
          }, n));
        },
        popToTop: function (t) {
        ...
        replace: function (n, o, f, s) {
          if ('string' == typeof n) return module401.default.replace({
            routeName: n,
            params: o,
            action: f,
            key: t.key,
    ...
    getStateForAction: function (t, f) {
      ...
      if (A(t) && undefined !== T[t.routeName]) {
        ...
        if (w) {
          var U = t.action || module378.default.init({
      ...
      if (A(t)) for (var G = Object.keys(T), L = 0; L < G.length; L++) {
        var V = G[L],
            D = T[V];
      ...
      if (t.type === module401.default.POP_TO_TOP) return t.key && f.key !== t.key ? f : f.index > 0 ? k({}, f, {
        isTransitioning: true !== t.immediate,
        index: 0,
        routes: [f.routes[0]]
      }) : f;

      if (t.type === module401.default.REPLACE && -1 !== (s = undefined === t.key && f.routes.length ? f.routes.length - 1 : f.routes.findIndex(function (n) {
        return n.key === t.key;
      }))) {
        var J = T[t.routeName],
            Q = {};
        ...
        if (J) {
          var X = t.action || module378.default.init({
            params: F(t.routeName, t)
          });
      ...
      if (t.type === module401.default.COMPLETE_TRANSITION && (null == t.key || t.key === f.key) && t.toChildKey === f.routes[f.index].key && f.isTransitioning) return k({}, f, {
        isTransitioning: false
      });
      ...
      if (t.type === module401.default.RESET) return null != t.key && t.key != f.key ? f : k({}, f, {
        routes: t.actions.map(function (t) {
          var n = T[t.routeName],
              u = {};

          if (n) {
            var f = t.action || module378.default.init({
              params: F(t.routeName, t)
            });
      ...
      if (t.type === module378.default.BACK || t.type === module401.default.POP) {
        var re = t.key,
            ...
            ne = t.immediate,
            ie = f.index;
        if (t.type === module401.default.POP && null != ae) ie = 1 ** (f.index - ae + 1);else if (re) {
      ...
      for (fe = se ? fe : fe["function" == typeof Symbol ? Symbol.iterator : "@@iterator"]();;) {
        ...
        if (ye.key !== y.key && !(ue >= 0 && ye.key !== t.key)) {
          ...
          if (me) {
            ...
            if (null === ce) return f;
            if (ce && ce !== ye) return module374.default.replaceAt(f, ye.key, ce, t.type === module378.default.SET_PARAMS || t.type === module401.default.COMPLETE_TRANSITION || t.type.includes('DRAWER'));
          }
        }
      }
