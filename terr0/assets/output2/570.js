export default function default(l, n, p) {
  var y = module524.cond(n.time, n.time, l),
      ...
      M = module524.sub(module524.multiply(V, q, C), module524.multiply(w, module524.sub(module524.multiply(k, module524.add(h, module524.multiply(V, q, T))), module524.multiply(_, T, j)))),
      ...
      A = module524.cond(module524.and(p.overshootClamping, module524.neq(p.stiffness, 0)), module524.cond(module524.lessThan(z, p.toValue), module524.greaterThan(n.position, p.toValue), module524.lessThan(n.position, p.toValue))),
  ...
  return module524.block([module524.set(z, n.position), module524.cond(module524.lessThan(V, 1), [module524.set(n.position, D), module524.set(n.velocity, M)], [module524.set(n.position, P), module524.set(n.velocity, S)]), module524.set(n.time, l), module524.cond(module524.or(A, module524.and(B, E)), [module524.cond(module524.neq(p.stiffness, 0), [module524.set(n.velocity, 0), module524.set(n.position, p.toValue)]), module524.set(n.finished, 1)])]);
}
