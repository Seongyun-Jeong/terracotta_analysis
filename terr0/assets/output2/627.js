...
export function defaultScrollInterpolator(t, n) {
  return {
    inputRange: u([1, 0, -1], t, n),
    outputRange: [0, 1, 0],
  };
}
export function defaultAnimatedStyles(t, n, p) {
  var l = {},
    u = {};
...
export function shiftAnimatedStyles(t, p, l) {
  var u = {},
    c = {},
    R = {};
...
export function stackScrollInterpolator(t, n) {
...
export function stackAnimatedStyles(t, p, o, u) {
...
export function tinderScrollInterpolator(t, n) {
  var p = module2 ? [1, 0, -1, -2, -3] : [3, 2, 1, 0, -1];
  return {
    inputRange: u(p, t, n),
    outputRange: p,
...
export function tinderAnimatedStyles(t, p, o, u) {
  var c = o.vertical ? o.itemHeight : o.itemWidth,
    R = o.vertical ? 'translateY' : 'translateX',
