var module9 = require('@babel/runtime/helpers/defineEnumerableProperties'),
  module46 = require('./46');
...
var module186 = require('./186'),
  ...
  p = {
    componentDidMount: function () {
      if (module43.isTV) {
        this._tvEventHandler = new module189();

        this._tvEventHandler.enable(this, function (t, E) {
          var R = module78.findNodeHandle(t);
          E.dispatchConfig = {};
          if (R === E.tag)
            'focus' === E.eventType
    ...
    _remeasureMetricsOnActivation: function () {
      ...
      if (null != t) module42.measure(t, this._handleQueryLayout);
    },
    _handleQueryLayout: function (t, E, R, o, _, S) {
      if (t || E || R || o || _ || S) {
        if (this.state.touchable.positionOnActivate) module188.release(this.state.touchable.positionOnActivate);
        if (this.state.touchable.dimensionsOnActivate) module186.release(this.state.touchable.dimensionsOnActivate);
        this.state.touchable.positionOnActivate = module188.getPooled(_, S);
        this.state.touchable.dimensionsOnActivate = module186.getPooled(R, o);
      }
    },
  ...
  C = module9(p, ['touchableHandleFocus', 'touchableHandleBlur']);
