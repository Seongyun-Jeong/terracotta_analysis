    ...
    function n() {
      ...
      o._getViewStyles = function () {
        var t = o.state.viewWidth,
          ...
          S = n.paddingRight,
          P = undefined === S ? h : S,
          B = module370.default(n, ['padding', 'paddingVertical', 'paddingHorizontal', 'paddingTop', 'paddingBottom', 'paddingLeft', 'paddingRight']);
    ...
    module357.default(n, [
      ...
      },
      {
        ...
        value: function () {
          var t = this,
            n = this.props,
            p = module370.default(n, ['forceInset', 'isLandscape', 'style']),
